...
death_zone3 = supervisor.getFromDef("DEATHZONE_3")
death_zone4 = supervisor.getFromDef("DEATHZONE_4")
...
deathzone_xyz3 = death_zone3.getField("translation").getSFVec3f()
deathzone_xyz4 = death_zone4.getField("translation").getSFVec3f()
...
while supervisor.step(TIME_STEP) != -1:
    ...
    if cage_death(values1, 0.4):
        os.system('echo \\nCage Fight, ' + cont1str + ', ' + cont2str + ', 2 >> ..\\..\\..\\UI\\public\\gamescores.txt')
        supervisor.setLabel(1, "robot 2 wins", 0.2, 0.2, 0.1, 000, 0, "Arial")
        supervisor.simulationQuit(1)
    if cage_death(values2, 0.4):
        os.system('echo \\nCage Fight, ' + cont1str + ', ' + cont2str + ', 1 >> ..\\..\\..\\UI\\public\\gamescores.txt')
        supervisor.setLabel(1, "robot 1 wins", 0.2, 0.2, 0.1, 000, 0, "Arial")
        supervisor.simulationQuit(1)
    
    if Robot.getTime(supervisor) > 60:
        os.system('echo \\nCage Fight, ' + cont1str + ', ' + cont2str + ', 4 >> ..\\..\\..\\UI\\public\\gamescores.txt')
        supervisor.setLabel(1, "robot 1 wins", 0.2, 0.2, 0.1, 000, 0, "Arial")
        supervisor.simulationQuit(1)
