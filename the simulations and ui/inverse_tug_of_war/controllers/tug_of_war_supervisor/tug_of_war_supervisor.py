...
while supervisor.step(TIME_STEP) != -1:
    ...
    if robot_in_zone(values1, deathzone_xyz2, 0.4):
        os.system('echo \\nTug OF War, ' + cont1str + ', ' + cont2str + ', 1 >> ..\\..\\..\\UI\\public\\gamescores.txt')
    ...
    if robot_in_zone(values2, deathzone_xyz1, 0.4):
        os.system('echo \\nTug OF War, ' + cont1str + ', ' + cont2str + ', 2 >> ..\\..\\..\\UI\\public\\gamescores.txt')
        supervisor.setLabel(1, "robot 2 wins", 0.2, 0.2, 0.1, 000, 0, "Arial")
        supervisor.simulationQuit(1)

    if Robot.getTime(supervisor) > 60:
        os.system('echo \\nTug OF War, ' + cont1str + ', ' + cont2str + ', 4 >> ..\\..\\..\\UI\\public\\gamescores.txt')
        supervisor.setLabel(1, "robot 2 wins", 0.2, 0.2, 0.1, 000, 0, "Arial")
        supervisor.simulationQuit(1)
